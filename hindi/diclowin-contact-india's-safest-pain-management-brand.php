...
<head>
  ...
  <meta name="title" content="संपर्क करें - भारत के सबसे सुरक्षित दर्द प्रबंधन ब्रांड - Diclowin">
  <meta name="description" content="संपर्क करें विंग्स फार्मास्युटिकल्स प्राइवेट लिमिटेड"/>
  
  <link rel="canonical" href="<?php echo $url;?>">
  <title>संपर्क करें - भारत के सबसे सुरक्षित दर्द प्रबंधन ब्रांड - Diclowin</title>
</head>
...
<?php include 'header.php';?>
  ...
  <section id="services" class="services2">
      <div class="container text-center">
        ...
        <img src="../assets/img/wings.png" class="img-fluid pb-3" alt="">
        <h1>संपर्क करें</h1>
        <h2 class="fs-3">विंग्स फार्मास्युटिकल्स प्राइवेट लिमिटेड</h2>
        ...
        <div class="row gx-3 justify-content-center">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 ">
            <div class="icon-box w-100 border">
              <div class="">
                <h3 class="h4">Whatsapp के माध्यम से जुड़ें</h3>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 ">
            <div class="icon-box w-100 border">
              <div class="">
                <div class="py-2">
                  <h4 class="fs-4 fw-bold">पता</h4>
                  <p class="fs-5">
                    विंग्स फार्मास्युटिकल्स प्राइवेट लिमिटेड <br>
                    D-6 उद्योग नगर Indl. क्षेत्र, <br>
                    नई दिल्ली-110041, भारत
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 ">
            <div class="icon-box w-100 border">
              <div class="">
                <h5 class="fs-4 fw-bold">टोल फ्री हेल्पलाइन</h5>
                  <div class="pt-2">
                    <a href="tel:18001205251" class="border border-dark p-2 text-dark"><i class="fa fa-phone"></i> 1800 120 5251</a>
                  </div>
                  <br>
                <h6 class="fs-4 fw-bold">मिस्ड कॉल दें डाईक्लोविन <br>नी ऑयल के लिए</h6>
                  <div class="pt-2">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0 ">
            <div class="icon-box w-100 border">
              <div class="">
                <h2 class="fs-4 fw-bold">लिखें</h2>
                  ...
                  <br>
                  <h3 class="fs-4 fw-bold">हमें फॉलो करे</h3>
...
<div class="container-fluid brands_con py-5">
  <div class="text-center h2 py-3 text-success border-bottom border-success">हमारे ब्रांड्स</div>
